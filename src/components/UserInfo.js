      ...
      <Container>
        <div className="d-flex flex-column flex-md-row justify-content-around align-items-center">
          <div className="order-2 order-md-1">
            ...
            <p>{ firstName } started using treehouse in { year }. Over the past { currentYearDiff } years { firstName } has achieved { numberOfBadges } badges and {data.points.total.toLocaleString()} points.</p>
          </div>
